...
#ifndef EXAMPLE_FIELD_LOOP_FIELDLOOP_DRIVER_HPP_
#define EXAMPLE_FIELD_LOOP_FIELDLOOP_DRIVER_HPP_
...
class FieldLoopDriver : public MultiStageDriver {
 public:
  FieldLoopDriver(ParameterInput *pin, ApplicationInput *app_in, Mesh *pm);
  ...
  //         FieldLoopDriver::MakeTaskCollection (fieldloop_driver.cpp)
...
#endif // EXAMPLE_FIELD_LOOP_FIELDLOOP_DRIVER_HPP_
